...
function f3(){
    let input = +document.querySelector(".i-31").value;
...
function f7(){
    let input = +document.querySelector(".i-71").value;
...
function f14(){
    let input = +document.querySelector(".i-141").value;
...
function f15(){
    let select = +document.querySelector(".s-151").value;
    ...
    switch (select3){
        case "&&":
            output.innerHTML = select + "&&" + select2;
            break;
        default:
            output.innerHTML = select + "||" + select2;
    }
