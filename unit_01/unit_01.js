...
document.querySelector(".three").innerHTML = "<h3>Ляляля</h3>";
...
document.querySelector(".four").innerHTML = "<h4>Один</h4>";
document.querySelector(".four").innerHTML += "<p>Два</p>";
