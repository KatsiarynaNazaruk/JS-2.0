...
function t12() {
    const input = document.querySelector(".i-12_1");
    const input2 = document.querySelector(".i-12_2");
    const output = document.querySelector(".out-12");
    output.innerHTML = "Hello " + input.value + " " + input2.value;
}
...
function t13() {
    const input = document.querySelector(".i-13_1");
    const input2 = document.querySelector(".i-13_2");
    const output = document.querySelector(".out-13");
    output.innerHTML = `${Number(input.value) + Number(input2.value)}`;
}
...
function t16() {
    const input = document.querySelector(".i-16-1");
    const input2 = document.querySelector(".i-16-2");
...
function t20() {
    const input = document.querySelector(".firstName").value;
    const input2 = document.querySelector(".lastName").value;
    const input3 = document.querySelector(".age").value;
    const input4 = document.querySelector(".work").value;
    const output = document.querySelector(".out-20");
    output.innerHTML = `Уважаемый ${input}, ${input2}, ваш возраст ${input3} года, по профессии вы ${input4}`;
}
